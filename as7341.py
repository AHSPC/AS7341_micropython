...
class AS7341:  # pylint:disable=too-many-instance-attributes, no-member
    ...
    * @return true: success false: failure
    ...
    def get_readings(self, log_errors: bool = False):
        """Convenience method (for AHS Electronics Workshop Class) to get all color channels mapped to their names. Calls itself recursively to effectively ignore OSErrors"""
        try:
